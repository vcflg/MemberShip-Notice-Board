...
<body>
	<%
		...
		if(bbsID==0){
			...
			script.println("laction.href = 'bbs.jsp'");
			script.println("</script>");		
		}
			...
			<div class="row">
					<table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
						...
						<tbody>
							...
							<tr>
								<td>내용</td>
								<td colspan="2" style="min-height:200px; text-align:center;"><%= bbs.getBbsContent().replaceAll(" ", "&nbsp") %></td>
							</tr>
						</tbody>								
					</table>
				...
				%>		
					...
					<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="control.jsp?bbsID=<%=bbsID %>&action=delete" class="btn btn-primary">삭제</a>
				<%
					}
				%>
